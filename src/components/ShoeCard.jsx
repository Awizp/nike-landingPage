...
const ShoeCard = ({ imageURL, changeBigShoeImg, bigShoeImg }) => {
    ...
    return (
        <div
            className={`border-2 rounded-xl ${bigShoeImg === imageURL.bigShoe ? "border-coral-red" : "border-transparent"} cursor-pointer max-sm:flex-1`}
            onClick={handleClick}
        >
            <div className='flex justify-center items-center bg-card bg-center bg-cover sm:w-40 sm:h-40 rounded-xl max-sm:padding-4'>
                <img src={imageURL.thumbnail} alt="shoe-img" width={127} height={103}
