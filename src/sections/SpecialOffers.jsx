    ...
    return (
        <section className='flex justify-center items-center max-xl:flex-col-reverse gap-10 max-container'>
            ...
            <div className='flex flex-1 flex-col'>
                ...
                <p className='mt-4 lg:max-w-lg info-text'>Embark on a shipping journey that redefines your experience with unbeatable deals. From premium selections to incredible savings, we offer unparalleled value that sets us apart.</p>
