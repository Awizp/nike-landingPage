    ...
    return (
        <footer className='max-container'>
            <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
                ...
                <div className='flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap'>
                    {footerLinks.map((link) => (
                        <div key={link}>
                            <h4 className='text-white font-montserrat text-2xl leading-normal font-md mb-6'>{link.title}</h4>
                            <ul>
                                {link.links.map((link) => (
                                    <li className='mt-3 text-white-400 font-montserrat text-bade leading-normal hover:text-slate-gray cursor-pointer' key={link.name}>
                                        <a>{link.name}</a>
                                    </li>
                                ))}
                            </ul>
            ...
            <div className='flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center'>
                <div className='flex-1 flex justify-center items-center cursor-pointer gap-2 font-montserrat'>
